<template>
  <div class="mod-home">
    ...
    <div class="img-container">
		<img src="../../assets/img/t.jpg" @click="clk(0)" style="width: 400px;height: 400px;scroll-padding-left: 80px;">
		<img src="../../assets/img/a.jpeg" @click="clk(1)" style="width: 400px;height: 400px;">
    </div>
...
export default {
  ...
  methods: {
	clk: function(i) {
		this.eleindex = i
		console.log(this.eleindex)
		var newPath = ''
		if(this.eleindex == 0) {
			newPath = '/txtTrans/txt'
		} else {
			newPath = '/audioTrans/audio'
		}
		this.$router.push({
			path: newPath
		})
...
window.onload = () => {
	...
	class Char {
		...
		render() {
			...
			const COL = `rgba(0, 0, ${100 * BRIGHTNESS | 0 + 150}, ${BRIGHTNESS})`;
